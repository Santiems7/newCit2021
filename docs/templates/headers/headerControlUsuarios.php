...
<header class="container-fluid navbar justify-content-end sticky-top ms-sm-auto flex-md-nowrap bg-white p-0">  
    <ul class="nav justify-content-center">
        <li class="nav-item">
        <a class="nav-link p-1" aria-current="page" href="controlUsuarios.php"><button type="button" class="btn btn-light">Administraci&oacute;n de usuarios</button></a>
        </li>
        <li class="nav-item">
        <a class="nav-link p-1" href="registro.php"><button type="button" class="btn btn-light">Registro</button></a>
        </li>
        <li>
